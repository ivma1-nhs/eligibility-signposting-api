Feature: Full mTLS integration with real Eligibility API and seeded DynamoDB data
  ...
  Scenario Outline: Eligibility check returns 200 OK for valid seeded NHS number
    Given I generate the test data files (optional)
    And I upload the test data files to DynamoDB (optional)
